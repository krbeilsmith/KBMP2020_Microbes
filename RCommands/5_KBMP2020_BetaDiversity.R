...
Rare_physeq <- rarefy_even_depth(physeq_forBetaDiv,500)
uni_Rare <- UniFrac(Rare_physeq, weighted=FALSE, normalized=FALSE, parallel=TRUE, fast=TRUE)
raup_Rare <- phyloseq::distance(Rare_physeq, method = "raup")
bray_Rare <- phyloseq::distance(Rare_physeq, method = "bray")
